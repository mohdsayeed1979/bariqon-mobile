# Release-build keep rules, per the Android release-hardening integration.
...
# eliminates it; see INTEGRATION_REPORT.md for the on-device regression
# testing this still needs before shipping.
