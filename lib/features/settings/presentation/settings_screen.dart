...
/// [localeProvider]), Theme (real, persisted across restarts — see
/// [themeModeProvider]), Security (App Lock), Notifications, and live app
/// version. About/Contact/Privacy/Terms live only on Profile's signed-in
/// list now (they were duplicated here before) — reachable from Profile's
/// app bar action for Guest/Signed Out sessions, which have no in-list
/// rows of their own.
